...
# Define o título da página, icônica e layout para ocupar toda a largura
st.set_page_config(
...
# ----- Fiitragem do DataFrame -----
# O dataframe principal é filtrado com base nas seleções feitas naa barra lateral
df_filtrado = df[
